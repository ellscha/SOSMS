...
extension ViewController {
    ...
    func onBoardingUI() {
        ...
        nameInfo = setupClass.setupLabel(vc: self, x: 80.0, y: 100.0, width: width, height: 40.0)
        
        nameInfo.text = "Customize Sender Name here!"
        
        
        messageInfo = setupClass.setupLabel(vc: self, x: 80.0, y: 200.0, width: width, height: 100.0)
        messageInfo.text = "Customize Message Body here!"
...
//        let width = Double(self.view.frame.size.width * 0.9)
//
//        self.statusLabel1 = setupClass.setupLabel(vc: self, x: x, y: 100.0, width: width, height: 40.0)
//        self.statusLabel2 = setupClass.setupLabel(vc: self, x: x, y: 150.0, width: width, height: 40.0)
//        self.statusLabel3 = setupClass.setupLabel(vc: self, x: x, y: 200.0, width: width, height: 40.0)
//        self.statusLabel4 = setupClass.setupLabel(vc: self, x: x, y: 250.0, width: width, height: 40.0)
//        self.statusLabel5 = setupClass.setupLabel(vc: self, x: x, y: 300.0, width: width, height: 40.0)
//
...
//        self.statusLabel5.isHidden = false
        ...
        self.senderTextField.backgroundColor = .red
...
//        self.senderTextField.backgroundColor = .lightGray
...
//        setupStatusLabels()
        ...
        messageSentLabel = setupClass.setupLabel(vc: self, x: x, y: 500.0, width: width, height: 80.0)
        
        messageSentLabel.alpha = 0.0
        messageSentLabel.backgroundColor = .systemTeal
        messageSentLabel.text = "You will get a notification in a minute."
        ...
        startButton.setTitle("Send Notification", for: UIControl.State.normal)
